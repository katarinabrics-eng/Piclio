  ...
  <div style={{
    ...
    <div style={{ textAlign: 'center', marginBottom: 24 }}>
      ...
      {initialEvent.slideshow_welcome_text && (
        <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.35)' }}>{initialEvent.slideshow_welcome_text}</div>
      )}
    </div>
    ...
    <div style={{ display: 'flex', gap: 14, width: '100%', maxWidth: 660, alignItems: 'flex-start' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 10, minWidth: 130 }}>
        <button onClick={() => { setShowIntro(false); setIntroDismissed(true) }}
        ...
        <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.2)', textAlign: 'center' as const }}>nebo Enter</div>
