  ...
  <div class="wrap">
    <div class="contact-grid">
      ...
      <form class="cform reveal" data-d="1" id="poptForm" novalidate>
        ...
        <p class="cform-note">Odesláním souhlasíte se zpracováním údajů dle <a href="/gdpr" style="color:var(--muted);text-decoration:underline">zásad ochrany osobních údajů</a>. Nezávazné, bez automatů.</p>
      </form>
    </div>
  </div>
</section>
