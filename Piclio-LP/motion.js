...
// Aura color shift on alt-bg sections
(function () {
  var ALT  = { '--aura1': '#C026D3', '--aura2': '#9333EA', '--aura3': '#DB2777' };
  var BASE = { '--aura1': '#9A3CF0', '--aura2': '#7C2BD9', '--aura3': '#B14DF0' };
  var active = 0;
  var io = new IntersectionObserver(function (entries) {
    entries.forEach(function (e) {
      if (e.isIntersecting) active++;
      else active = Math.max(0, active - 1);
      var colors = active > 0 ? ALT : BASE;
